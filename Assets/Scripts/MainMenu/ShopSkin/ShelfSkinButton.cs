...
{
	public class ShelfSkinButton : SkinButton
	{
		public override void Init(Skin skin, SkinGroup skinGroup)
		{
			base.Init(skin, skinGroup);
			_skinImage.sprite = SkinDataController.Instance.GetShelfSkinIcon(_skin.Id);
		}
		...
		public override void ToggleUse()
		{
			...
			if (SkinGroup.SkinInUse != null)
			{
				...
				((ShelfSkinButton)SkinGroup.SkinInUse).RemoveInUse();
			}
